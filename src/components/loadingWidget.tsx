...
const LoadingWidget = () => {
    ...
    return (
        <div className="2xl:w-1/6 md:w-1/5 w-4/5 h-min absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg rounded-xl text-center z-10">
            <div className="">
